# Org.OpenAPITools - the C# library for the Book Service API
...
*BookApi* | [**BookPost**](docs/BookApi.md#bookpost) | **POST** /book | 
*DefaultApi* | [**BookIdGet**](docs/DefaultApi.md#bookidget) | **GET** /book/{id} | 
